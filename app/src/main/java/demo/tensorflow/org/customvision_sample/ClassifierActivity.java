...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final Size DESIRED_PREVIEW_SIZE = new Size(getScreenHeight(), getScreenWidth());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.findViewById(R.id.info_button).setOnClickListener(new View.OnClickListener() {
            @Override
